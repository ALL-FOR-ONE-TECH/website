...
export function FeatureBanner() {
  return (
    <section className="relative py-4 overflow-hidden border-y border-white/5">
      {/* Background */}
